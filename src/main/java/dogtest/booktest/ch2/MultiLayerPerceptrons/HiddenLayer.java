...
import static dogtest.booktest.ch2.MultiLayerPerceptrons.util.ActivationFunction.*;
import static dogtest.booktest.ch2.MultiLayerPerceptrons.util.RandomGenerator.uniform;
